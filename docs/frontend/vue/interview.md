...
P beforeCreate > P created > P beforeMount > * > P mounted

C beforeCreate > C created > C beforeMount > C mounted

- 更新

P beforeUpdate > * > P updated

C beforeUpdate > C updated

- 销毁

P beforeDestroy > * > P destroyed
